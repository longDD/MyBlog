    ...
    <body>
        <div class="m-left">
            <ul class="nav nav-pills nav-stacked" id="m-list">
                <li class="active"><a href="<?php echo site_url('admin/art_add'); ?>" target="main">添加</a></li>
                <li><a href="<?php echo site_url('admin/art_list'); ?>" target="main">博文列表</a></li>
                <li><a href="<?php echo site_url('admin/art_type_list'); ?>" target="main">分类</a></li>
            </ul>
    </body>
</html>